            ...
            newMessage.save(function (err, message) {
                ...
                MessageModel.populateMessages(message, function (err, data) {
                    ...
                    if (onSucess) {
                        ...
                        // 이하 포인트 지급, 회원 포인트도 증가해야 한다. FCM Push 처리
                        var member_id = message.userID;
                        var room_id = message.roomID;
                        ...
                        form.submit('http://localhost:8080/api/chat/addpoint', function (err, res) {
                            if (err) {
                                // throw err;
                                console.log('포인트 적립 호출 에러!!! '+ err);
                            }
                        });
                    }

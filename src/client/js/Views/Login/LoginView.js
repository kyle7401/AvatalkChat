...
var LoginView = Backbone.View.extend({
    ...
    validate: function () {
        ...
        // 테스트용으로 id와 사용자명 동일하게 처리
        if (_.isEmpty(id)) {

            result = false;

            SS('#input-id').parent().find('.label-error').text("사용자 ID를 입력해 주세요!");
